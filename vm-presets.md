...
`kubectl describe` can be used to show all `Events`. For example:
...
Events:
  ...
  Thu, 11 Jan 2018 08:34:14 -0500   Thu, 11 Jan 2018 08:34:14 -0500 1     {vmpreset.admission.kubernetes.io/vmpreset-allow-database }    conflict  Conflict on virtual machine preset. Duplicate mountPath /cache.
