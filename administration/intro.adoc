...
* https://kubernetes.io[Kubernetes] cluster or derivative (such as https://github.com/openshift/origin[OpenShift], Tectonic) based on Kubernetes 1.10 or greater
...
KubeVirt can be installed on a Kubernetes cluster using the KubeVirt operator.

The example below demonstrats how to install KubeVirt using the operator using
a specific upstream version of KubeVirt.
...
Installing `virtctl` client tooling
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Updating a KubeVirt Installation
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Deleting a KubeVirt Installation
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
