...
- **Beta** features are considered stable enough for broad testing.
  ...
  **enabled by default**. See
  ...
  for full details.
  <!-- TODO: link blog post in https://github.com/kubevirt/kubevirt.github.io/pull/1027
  once published (Beta features on by default) -->
- **GA** features are always enabled and cannot be toggled.
...
**Note:** feature gate names are case sensitive.
...
recommended way to opt out of Beta features that are enabled by
default.
