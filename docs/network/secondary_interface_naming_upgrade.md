...
However, the ordinal scheme is **incompatible with [NIC hot-unplug](hotplug_interfaces.md#removing-an-interface-from-a-running-vm)** and
...
Please refer to the [Live Migration](../compute/live_migration.md) documentation
