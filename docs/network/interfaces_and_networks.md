...
> **Note**: The passt binding is in Beta stage. Please use it with care.

> **Note**: Additional memory overhead of `250Mi` will be requested for the compute container in the virt-launcher pod. 
