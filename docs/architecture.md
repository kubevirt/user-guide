...
found in [Run Strategies](./run_strategies.md)
...
Find more details about [a VM's life-cycle in the relevant section](./lifecycle.md)
...
See [Service Objects](./service_objects.md) for more details.
