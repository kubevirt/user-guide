...
This API is useful both for cloning Virtual Machines,
but also for creating "golden snapshots" that would be used as a template for creating new VMs
...
For example, write files, install applications, apply configurations, or anything else.
